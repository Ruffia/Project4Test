...
{
	Mat img = imread("U:/Project4Test/HelloWorld/Bin/206.jpg", CV_LOAD_IMAGE_GRAYSCALE); 
	Mat resultImg;
	...
	for(int i = 0; i < contours.size(); i++) 
	{
		...
		if(circularity > 0.8)
		{
			...
			centerpoint.at<float>(i,0) = mu.m10 / mu.m00; // x-coordinate centerpoint.at<double>(i,1) = mu.m01 / mu.m00; // y-coordinate centers.push_back(centerpoint);
		}
	...
	{
		printf("no circular blobs found"); return 0;
	}
