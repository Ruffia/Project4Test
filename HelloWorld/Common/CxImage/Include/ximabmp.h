...
//	bool Load(const char * imageFileName){ return CxImage::Load(imageFileName,CXIMAGE_FORMAT_BMP);}
//	bool Save(const char * imageFileName){ return CxImage::Save(imageFileName,CXIMAGE_FORMAT_BMP);}
...
protected:
	bool DibReadBitmapInfo(CxFile* fh,PDIB pdib);
};
