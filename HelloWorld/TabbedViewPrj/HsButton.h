...
class HsButton;
class HsButtonEventHandler
{
public:
	virtual int OnLHsButtonDown (HsButton* sender, UINT nFlags, CPoint point) = 0;
    virtual int OnLHsButtonUp (HsButton* sender, UINT nFlags, CPoint point) = 0;
};

class HsButton : public CButton
{
/////////////////////////////////////////////////////////////////////////////
// Construction
public:
...
protected:
  ...
  //! Button type.
  HsButton::Type m_type;

  //! Text style.
  HsButton::Text m_textStyle;

  //! Focus style.
  HsButton::Focus m_focusStyle;
...
public:
	void AttachEventHandler(HsButtonEventHandler* pEventHandler)
	{
		m_pEventHandler = pEventHandler;
	}

private:
	HsButtonEventHandler* m_pEventHandler; 
};
