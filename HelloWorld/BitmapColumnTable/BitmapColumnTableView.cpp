...
// BitmapColumnTableView.cpp : CBitmapColumnTableView 类的实现
//
...
CBitmapColumnTableDoc* CBitmapColumnTableView::GetDocument() const // 非调试版本是内联的
{
